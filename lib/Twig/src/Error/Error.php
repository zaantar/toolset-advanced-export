...
class Error extends \Exception
{
    ...
    public function __construct($message, $lineno = -1, $source = null, \Exception $previous = null)
    {
        if (null === $source) {
            $name = null;
        } elseif (!$source instanceof \ToolsetAdvancedExport\Twig\Source) {
    ...
    {
        return $this->filename ? new \ToolsetAdvancedExport\Twig\Source($this->sourceCode, $this->filename, $this->sourcePath) : null;
    }
    /**
     * Sets the source context of the Twig template where the error occurred.
     */
    public function setSourceContext(\ToolsetAdvancedExport\Twig\Source $source = null)
    {
        if (null === $source) {
    ...
    protected function guessTemplateInfo()
    {
        ...
        foreach ($backtrace as $trace) {
            if (isset($trace['object']) && $trace['object'] instanceof \ToolsetAdvancedExport\Twig\Template && 'Twig_Template' !== \get_class($trace['object'])) {
...
\class_alias('ToolsetAdvancedExport\\Twig\\Error\\Error', 'ToolsetAdvancedExport\\Twig_Error');
