...
EOF;
    ...
    private function dumpChildren($parent, \ToolsetAdvancedExport\Twig\Profiler\Profile $profile, &$data)
    {
    ...
    private function dumpProfile($edge, \ToolsetAdvancedExport\Twig\Profiler\Profile $profile, &$data)
    {
        if (isset($data[$edge])) {
            ++$data[$edge]['ct'];
...
\class_alias('ToolsetAdvancedExport\\Twig\\Profiler\\Dumper\\BlackfireDumper', 'ToolsetAdvancedExport\\Twig_Profiler_Dumper_Blackfire');
