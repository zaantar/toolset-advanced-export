 ...
 */
class MacroNode extends \ToolsetAdvancedExport\Twig\Node\Node
{
    const VARARGS_NAME = 'varargs';
    public function __construct($name, \ToolsetAdvancedExport\Twig_NodeInterface $body, \ToolsetAdvancedExport\Twig_NodeInterface $arguments, $lineno, $tag = null)
    {
        foreach ($arguments as $argumentName => $argument) {
            if (self::VARARGS_NAME === $argumentName) {
                throw new \ToolsetAdvancedExport\Twig\Error\SyntaxError(\sprintf('The argument "%s" in macro "%s" cannot be defined because the variable "%s" is reserved for arbitrary arguments.', self::VARARGS_NAME, $name, self::VARARGS_NAME), $argument->getTemplateLine(), $argument->getSourceContext());
            }
        }
...
\class_alias('ToolsetAdvancedExport\\Twig\\Node\\MacroNode', 'ToolsetAdvancedExport\\Twig_Node_Macro');
