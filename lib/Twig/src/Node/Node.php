 ...
 */
class Node implements \ToolsetAdvancedExport\Twig_NodeInterface
{
    protected $nodes;
    ...
    public function __construct(array $nodes = [], array $attributes = [], $lineno = 0, $tag = null)
    {
        foreach ($nodes as $name => $node) {
            if (!$node instanceof \ToolsetAdvancedExport\Twig_NodeInterface) {
    ...
    public function setSourceContext(\ToolsetAdvancedExport\Twig\Source $source)
    {
...
\class_alias('ToolsetAdvancedExport\\Twig\\Node\\Node', 'ToolsetAdvancedExport\\Twig_Node');
// Ensure that the aliased name is loaded to keep BC for classes implementing the typehint with the old aliased name.
\class_exists('ToolsetAdvancedExport\\Twig\\Compiler');
