 ...
 */
class IncludeNode extends \ToolsetAdvancedExport\Twig\Node\Node implements \ToolsetAdvancedExport\Twig\Node\NodeOutputInterface
{
    public function __construct(\ToolsetAdvancedExport\Twig\Node\Expression\AbstractExpression $expr, \ToolsetAdvancedExport\Twig\Node\Expression\AbstractExpression $variables = null, $only = \false, $ignoreMissing = \false, $lineno, $tag = null)
    {
        $nodes = ['expr' => $expr];
        if (null !== $variables) {
    ...
    protected function addTemplateArguments(\ToolsetAdvancedExport\Twig\Compiler $compiler)
    {
...
\class_alias('ToolsetAdvancedExport\\Twig\\Node\\IncludeNode', 'ToolsetAdvancedExport\\Twig_Node_Include');
