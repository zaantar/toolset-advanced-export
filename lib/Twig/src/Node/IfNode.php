 ...
 */
class IfNode extends \ToolsetAdvancedExport\Twig\Node\Node
{
    public function __construct(\ToolsetAdvancedExport\Twig_NodeInterface $tests, \ToolsetAdvancedExport\Twig_NodeInterface $else = null, $lineno, $tag = null)
    {
        $nodes = ['tests' => $tests];
        if (null !== $else) {
            $nodes['else'] = $else;
...
\class_alias('ToolsetAdvancedExport\\Twig\\Node\\IfNode', 'ToolsetAdvancedExport\\Twig_Node_If');
