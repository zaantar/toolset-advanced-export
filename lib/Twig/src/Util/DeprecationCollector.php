 ...
 */
namespace ToolsetAdvancedExport\Twig\Util;
...
class DeprecationCollector
{
    ...
    public function __construct(\ToolsetAdvancedExport\Twig\Environment $twig)
    {
        $this->twig = $twig;
    }
    /**
    ...
    public function collectDir($dir, $ext = '.twig')
    {
        ...
        return $this->collect(new \ToolsetAdvancedExport\Twig\Util\TemplateDirIterator($iterator));
    }
    /**
    ...
    public function collect(\Traversable $iterator)
    {
        ...
        foreach ($iterator as $name => $contents) {
            try {
                $this->twig->parse($this->twig->tokenize(new \ToolsetAdvancedExport\Twig\Source($contents, $name)));
...
\class_alias('ToolsetAdvancedExport\\Twig\\Util\\DeprecationCollector', 'ToolsetAdvancedExport\\Twig_Util_DeprecationCollector');
