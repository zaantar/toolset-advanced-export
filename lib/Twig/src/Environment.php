...
use ToolsetAdvancedExport\Twig\Cache\CacheInterface;
use ToolsetAdvancedExport\Twig\Cache\FilesystemCache;
use ToolsetAdvancedExport\Twig\Cache\NullCache;
...
use ToolsetAdvancedExport\Twig\Extension\CoreExtension;
use ToolsetAdvancedExport\Twig\Extension\EscaperExtension;
use ToolsetAdvancedExport\Twig\Extension\ExtensionInterface;
use ToolsetAdvancedExport\Twig\Extension\GlobalsInterface;
use ToolsetAdvancedExport\Twig\Extension\InitRuntimeInterface;
use ToolsetAdvancedExport\Twig\Extension\OptimizerExtension;
use ToolsetAdvancedExport\Twig\Extension\StagingExtension;
use ToolsetAdvancedExport\Twig\Loader\ArrayLoader;
use ToolsetAdvancedExport\Twig\Loader\ChainLoader;
...
use ToolsetAdvancedExport\Twig\RuntimeLoader\RuntimeLoaderInterface;
...
class Environment
{
    ...
    protected $templateClassPrefix = '\\ToolsetAdvancedExport\\__TwigTemplate_';
     ...
     */
    public function __construct(\ToolsetAdvancedExport\Twig\Loader\LoaderInterface $loader = null, $options = [])
    {
        if (null !== $loader) {
        ...
        $options = \array_merge(['debug' => \false, 'charset' => 'UTF-8', 'base_template_class' => '\\ToolsetAdvancedExport\\Twig\\Template', 'strict_variables' => \false, 'autoescape' => 'html', 'cache' => \false, 'auto_reload' => null, 'optimizations' => -1], $options);
        ...
        $this->addExtension(new \ToolsetAdvancedExport\Twig\Extension\CoreExtension());
        $this->addExtension(new \ToolsetAdvancedExport\Twig\Extension\EscaperExtension($options['autoescape']));
        $this->addExtension(new \ToolsetAdvancedExport\Twig\Extension\OptimizerExtension($options['optimizations']));
        $this->staging = new \ToolsetAdvancedExport\Twig\Extension\StagingExtension();
        // For BC
    ...
    public function setCache($cache)
    {
        if (\is_string($cache)) {
            ...
            $this->cache = new \ToolsetAdvancedExport\Twig\Cache\FilesystemCache($cache);
        } elseif (\false === $cache) {
            $this->originalCache = $cache;
            $this->cache = new \ToolsetAdvancedExport\Twig\Cache\NullCache();
        } elseif (null === $cache) {
            ...
            $this->cache = new \ToolsetAdvancedExport\Twig\Cache\NullCache();
        } elseif ($cache instanceof \ToolsetAdvancedExport\Twig\Cache\CacheInterface) {
    ...
    {
        if ($name instanceof \ToolsetAdvancedExport\Twig\TemplateWrapper) {
            return $name;
        }
        if ($name instanceof \ToolsetAdvancedExport\Twig\Template) {
            return new \ToolsetAdvancedExport\Twig\TemplateWrapper($this, $name);
        }
        return new \ToolsetAdvancedExport\Twig\TemplateWrapper($this, $this->loadTemplate($name));
    }
    /**
        ...
        if (!\class_exists($cls, \false)) {
            ...
            if (!\class_exists($cls, \false)) {
                ...
                if (!$loader instanceof \ToolsetAdvancedExport\Twig\Loader\SourceContextLoaderInterface) {
                    $source = new \ToolsetAdvancedExport\Twig\Source($loader->getSource($name), $name);
                } else {
            ...
            if (!\class_exists($cls, \false)) {
                throw new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('Failed to load Twig template "%s", index "%s": cache might be corrupted.', $name, $index), -1, $source);
            }
        }
    ...
    public function createTemplate($template, $name = null)
    {
        ...
        $loader = new \ToolsetAdvancedExport\Twig\Loader\ChainLoader([new \ToolsetAdvancedExport\Twig\Loader\ArrayLoader([$name => $template]), $current = $this->getLoader()]);
        $this->setLoader($loader);
        try {
            $template = new \ToolsetAdvancedExport\Twig\TemplateWrapper($this, $this->loadTemplate($name));
        } catch (\Exception $e) {
    ...
    public function resolveTemplate($names)
    {
        ...
        throw new \ToolsetAdvancedExport\Twig\Error\LoaderError(\sprintf('Unable to find one of the following templates: "%s".', \implode('", "', $names)));
    }
    /**
    ...
    public function getLexer()
    {
        ...
        if (null === $this->lexer) {
            $this->lexer = new \ToolsetAdvancedExport\Twig\Lexer($this);
        }
        return $this->lexer;
    }
    public function setLexer(\ToolsetAdvancedExport\Twig_LexerInterface $lexer)
    {
        $this->lexer = $lexer;
    }
    /**
    ...
    {
        if (!$source instanceof \ToolsetAdvancedExport\Twig\Source) {
            ...
            $source = new \ToolsetAdvancedExport\Twig\Source($source, $name);
        }
        if (null === $this->lexer) {
            $this->lexer = new \ToolsetAdvancedExport\Twig\Lexer($this);
        }
    ...
    public function getParser()
    {
        @\trigger_error(\sprintf('The %s() method is deprecated since version 1.25 and will be removed in 2.0.', __FUNCTION__), \E_USER_DEPRECATED);
        if (null === $this->parser) {
            $this->parser = new \ToolsetAdvancedExport\Twig\Parser($this);
        }
        return $this->parser;
    }
    public function setParser(\ToolsetAdvancedExport\Twig_ParserInterface $parser)
    {
        $this->parser = $parser;
    }
    /**
     ...
     */
    public function parse(\ToolsetAdvancedExport\Twig\TokenStream $stream)
    {
        if (null === $this->parser) {
            $this->parser = new \ToolsetAdvancedExport\Twig\Parser($this);
        }
    ...
    public function getCompiler()
    {
        ...
        if (null === $this->compiler) {
            $this->compiler = new \ToolsetAdvancedExport\Twig\Compiler($this);
        }
        return $this->compiler;
    }
    public function setCompiler(\ToolsetAdvancedExport\Twig_CompilerInterface $compiler)
    {
     ...
     */
    public function compile(\ToolsetAdvancedExport\Twig_NodeInterface $node)
    {
        if (null === $this->compiler) {
            $this->compiler = new \ToolsetAdvancedExport\Twig\Compiler($this);
        }
    ...
    public function compileSource($source, $name = null)
    {
        ...
        } catch (\ToolsetAdvancedExport\Twig\Error\Error $e) {
            $e->setSourceContext($source);
            throw $e;
        } catch (\Exception $e) {
            throw new \ToolsetAdvancedExport\Twig\Error\SyntaxError(\sprintf('An exception has been thrown during the compilation of a template ("%s").', $e->getMessage()), -1, $source, $e);
        }
    }
    public function setLoader(\ToolsetAdvancedExport\Twig\Loader\LoaderInterface $loader)
    {
        if (!$loader instanceof \ToolsetAdvancedExport\Twig\Loader\SourceContextLoaderInterface && 0 !== \strpos(\get_class($loader), 'Mock_')) {
    ...
    public function initRuntime()
    {
        ...
        foreach ($this->getExtensions() as $name => $extension) {
            if (!$extension instanceof \ToolsetAdvancedExport\Twig\Extension\InitRuntimeInterface) {
                $m = new \ReflectionMethod($extension, 'initRuntime');
                $parentClass = $m->getDeclaringClass()->getName();
                if ('Twig_Extension' !== $parentClass && 'ToolsetAdvancedExport\\Twig\\Extension\\AbstractExtension' !== $parentClass) {
     ...
     */
    public function addRuntimeLoader(\ToolsetAdvancedExport\Twig\RuntimeLoader\RuntimeLoaderInterface $loader)
    {
    ...
    public function getExtension($class)
    {
        ...
        if (!isset($this->extensionsByClass[$class])) {
            throw new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('The "%s" extension is not enabled.', $class));
        }
    ...
    public function getRuntime($class)
    {
        ...
        throw new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('Unable to load the "%s" runtime.', $class));
    }
    public function addExtension(\ToolsetAdvancedExport\Twig\Extension\ExtensionInterface $extension)
    {
    ...
    public function addTokenParser(\ToolsetAdvancedExport\Twig\TokenParser\TokenParserInterface $parser)
    {
        if ($this->extensionInitialized) {
    ...
    public function getTags()
    {
        ...
        foreach ($this->getTokenParsers()->getParsers() as $parser) {
            if ($parser instanceof \ToolsetAdvancedExport\Twig\TokenParser\TokenParserInterface) {
    ...
    {
        if (!$name instanceof \ToolsetAdvancedExport\Twig\TwigFilter && !($filter instanceof \ToolsetAdvancedExport\Twig\TwigFilter || $filter instanceof \ToolsetAdvancedExport\Twig_FilterInterface)) {
            throw new \LogicException('A filter must be an instance of \\Twig_FilterInterface or \\Twig_SimpleFilter.');
        }
        if ($name instanceof \ToolsetAdvancedExport\Twig\TwigFilter) {
            $filter = $name;
            $name = $filter->getName();
        } else {
    ...
    {
        if (!$name instanceof \ToolsetAdvancedExport\Twig\TwigTest && !($test instanceof \ToolsetAdvancedExport\Twig\TwigTest || $test instanceof \ToolsetAdvancedExport\Twig_TestInterface)) {
            throw new \LogicException('A test must be an instance of \\Twig_TestInterface or \\Twig_SimpleTest.');
        }
        if ($name instanceof \ToolsetAdvancedExport\Twig\TwigTest) {
            $test = $name;
            $name = $test->getName();
        } else {
    ...
    {
        if (!$name instanceof \ToolsetAdvancedExport\Twig\TwigFunction && !($function instanceof \ToolsetAdvancedExport\Twig\TwigFunction || $function instanceof \ToolsetAdvancedExport\Twig_FunctionInterface)) {
            throw new \LogicException('A function must be an instance of \\Twig_FunctionInterface or \\Twig_SimpleFunction.');
        }
        if ($name instanceof \ToolsetAdvancedExport\Twig\TwigFunction) {
            $function = $name;
    ...
    public function computeAlternatives($name, $items)
    {
        ...
        return \ToolsetAdvancedExport\Twig\Error\SyntaxError::computeAlternatives($name, $items);
    }
    /**
     * @internal
     */
    protected function initGlobals()
    {
        ...
        foreach ($this->extensions as $name => $extension) {
            if (!$extension instanceof \ToolsetAdvancedExport\Twig\Extension\GlobalsInterface) {
    ...
    protected function initExtensions()
    {
        ...
        $this->parsers = new \ToolsetAdvancedExport\Twig_TokenParserBroker([], [], \false);
        $this->filters = [];
        $this->functions = [];
        $this->tests = [];
        $this->visitors = [];
     ...
     * @internal
     */
    protected function initExtension(\ToolsetAdvancedExport\Twig\Extension\ExtensionInterface $extension)
    {
        // filters
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            ...
            } elseif ($parser instanceof \ToolsetAdvancedExport\Twig_TokenParserBrokerInterface) {
    ...
    {
        $hashParts = \array_merge(\array_keys($this->extensions), [(int) \function_exists('ToolsetAdvancedExport\\twig_template_get_attributes'), \PHP_MAJOR_VERSION, \PHP_MINOR_VERSION, self::VERSION, (int) $this->debug, $this->baseTemplateClass, (int) $this->strictVariables]);
        $this->optionsHash = \implode(':', $hashParts);
    }
}
\class_alias('ToolsetAdvancedExport\\Twig\\Environment', 'ToolsetAdvancedExport\\Twig_Environment');
