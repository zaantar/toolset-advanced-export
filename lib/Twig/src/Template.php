 ...
 * @internal
 */
abstract class Template implements \ToolsetAdvancedExport\Twig_TemplateInterface
{
    /**
     * @internal
     */
    ...
    {
        return new \ToolsetAdvancedExport\Twig\Source('', $this->getTemplateName());
    }
    /**
    ...
    public function getParent(array $context)
    {
        ...
        try {
            ...
            if ($parent instanceof self || $parent instanceof \ToolsetAdvancedExport\Twig\TemplateWrapper) {
    ...
    public function displayParentBlock($name, array $context, array $blocks = [])
    {
        ...
        if (isset($this->traits[$name])) {
            ...
            throw new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('The template has no parent and no traits defining the "%s" block.', $name), -1, $this->getSourceContext());
        }
    }
    /**
     * Displays a block.
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = \true)
    {
        ...
        if (null !== $template) {
            try {
                ...
                $e = new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $template->getSourceContext(), $e);
                $e->guess();
                throw $e;
            }
        } elseif (\false !== ($parent = $this->getParent($context))) {
    ...
    protected function loadTemplate($template, $templateName = null, $line = null, $index = null)
    {
        try {
            ...
            if ($template instanceof self || $template instanceof \ToolsetAdvancedExport\Twig\TemplateWrapper) {
                return $template;
            }
            ...
            if (!$e->getSourceContext()) {
                $e->setSourceContext($templateName ? new \ToolsetAdvancedExport\Twig\Source('', $templateName) : $this->getSourceContext());
            }
    ...
    protected function displayWithErrorHandling(array $context, array $blocks = [])
    {
        try {
            ...
            $e = new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, $this->getSourceContext(), $e);
            $e->guess();
            throw $e;
        }
    }
    ...
    protected final function getContext($context, $item, $ignoreStrictCheck = \false)
    {
        if (!\array_key_exists($item, $context)) {
            ...
            throw new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('Variable "%s" does not exist.', $item), -1, $this->getSourceContext());
        }
        return $context[$item];
    }
    /**
    ...
    protected function getAttribute($object, $item, array $arguments = [], $type = self::ANY_CALL, $isDefinedTest = \false, $ignoreStrictCheck = \false)
    {
        ...
        if (self::METHOD_CALL !== $type) {
            ...
            if (self::ARRAY_CALL === $type || !\is_object($object)) {
                ...
                throw new \ToolsetAdvancedExport\Twig\Error\RuntimeError($message, -1, $this->getSourceContext());
            }
        }
        if (!\is_object($object)) {
            if ($isDefinedTest) {
        ...
        if (self::METHOD_CALL !== $type && !$object instanceof self) {
            ...
            if (isset($object->{$item}) || \array_key_exists((string) $item, $object)) {
                ...
                if ($this->env->hasExtension('ToolsetAdvancedExport\\Twig\\Extension\\SandboxExtension')) {
                    $this->env->getExtension('ToolsetAdvancedExport\\Twig\\Extension\\SandboxExtension')->checkPropertyAllowed($object, $item);
                }
                return $object->{$item};
            }
        }
        ...
        if (isset(self::$cache[$class][$item])) {
            ...
            throw new \ToolsetAdvancedExport\Twig\Error\RuntimeError(\sprintf('Neither the property "%1$s" nor one of the methods "%1$s()", "get%1$s()"/"is%1$s()" or "__call()" exist and have public access in class "%2$s".', $item, $class), -1, $this->getSourceContext());
        }
        if ($isDefinedTest) {
            return \true;
        }
        if ($this->env->hasExtension('ToolsetAdvancedExport\\Twig\\Extension\\SandboxExtension')) {
            $this->env->getExtension('ToolsetAdvancedExport\\Twig\\Extension\\SandboxExtension')->checkMethodAllowed($object, $method);
        }
        ...
        // @deprecated in 1.28
        if ($object instanceof \ToolsetAdvancedExport\Twig_TemplateInterface) {
            ...
            return '' === $ret ? '' : new \ToolsetAdvancedExport\Twig\Markup($ret, $this->env->getCharset());
        }
        return $ret;
    }
}
\class_alias('ToolsetAdvancedExport\\Twig\\Template', 'ToolsetAdvancedExport\\Twig_Template');
