 ...
 */
class Compiler implements \ToolsetAdvancedExport\Twig_CompilerInterface
{
    protected $lastLine;
    protected $source;
     ...
     * @return $this
     */
    public function compile(\ToolsetAdvancedExport\Twig_NodeInterface $node, $indentation = 0)
    {
        $this->lastLine = null;
        $this->source = '';
        $this->debugInfo = [];
    ...
    public function subcompile(\ToolsetAdvancedExport\Twig_NodeInterface $node, $raw = \true)
    {
        if (\false === $raw) {
     ...
     * @return $this
     */
    public function addDebugInfo(\ToolsetAdvancedExport\Twig_NodeInterface $node)
    {
...
\class_alias('ToolsetAdvancedExport\\Twig\\Compiler', 'ToolsetAdvancedExport\\Twig_Compiler');
