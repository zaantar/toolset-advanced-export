 ...
 * @internal
 */
class StagingExtension extends \ToolsetAdvancedExport\Twig\Extension\AbstractExtension
{
    protected $functions = [];
    protected $filters = [];
    protected $visitors = [];
...
\class_alias('ToolsetAdvancedExport\\Twig\\Extension\\StagingExtension', 'ToolsetAdvancedExport\\Twig_Extension_Staging');
